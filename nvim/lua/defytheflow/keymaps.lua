...
vim.keymap.set("n", "<leader>cm", function()
  local format_options = vim.o.formatoptions
  local new_format_options = ""

  if format_options:match("[cro]") then
    new_format_options = format_options:gsub("[cro]", "")
  else
    new_format_options = format_options .. "cro"
  end

  vim.o.formatoptions = new_format_options
